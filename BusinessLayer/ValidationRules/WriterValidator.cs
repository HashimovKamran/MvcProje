...
namespace BusinessLayer.ValidationRules
{
    public class WriterValidator : AbstractValidator<Writer>
    {
        public WriterValidator()
        {
            ...
            RuleFor(x => x.WriterName).NotEmpty().WithMessage("Yazar soy adını boş geçemezsiniz");
            ...
            RuleFor(x => x.WriterAbout).Must(list => list.Contains("a")).WithMessage("Hakkımda kısmında A harfi olması lazım");
        }
    }
}
